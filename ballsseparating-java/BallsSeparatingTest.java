...
public class BallsSeparatingTest {
	...
	public void testCase5() {
		int[] red = new int[] { 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150, 75799, 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907,
				256150, 75799, 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150, 75799, 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150,
				75799, 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150, 75799, 842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150, 75799,
				842398, 491273, 958925, 849859, 771363, 67803, 184892, 391907, 256150, 75799 };

		int expected = arsum(red) * 2;
		int actual = solution.minOperations(red, red, red);
